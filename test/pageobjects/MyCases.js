...
class MyCases extends Page {
    ...
    get case1 () {
        return $(`[class*="fui-DataGridBody"]>[class*="fui-DataGridRow"]:nth-of-type(1)>[class*="fui-DataGridCell"]:nth-of-type(1)`);
    }
    get caseTypeValue () {
    ...
    get case2 () {
        return $(`[class*="fui-DataGridBody"]>[class*="fui-DataGridRow"]:nth-of-type(2)>[class*="fui-DataGridCell"]:nth-of-type(1)`);
    }
    get casePage () {
    ...
    get clientIcon () {
        return $('[role="row"]:nth-of-type(1)>[role="gridcell"]>[class*="fui-TableCellLayout"]>[class*="fui-TableCellLayout__content"]>[class="fui-TableCellLayout__main"]>[style="scrollbar-width: thin;"]>[class="fui-Persona rlroi9i ___1gusw2c f1iantul"]>[role="img"]');
    }
}
